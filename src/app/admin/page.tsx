  ...
  const handleCreateApartment = async (
    ...
    try {
      ...
      if (managerError || !manager) {
        throw managerError ?? new Error("Yönetici oluşturulamadı.");
      }
      ...
      const { data: apartment, error: apartmentError } = await supabase
        ...
        .insert({
          name: form.name.trim(),
          unit_count: isNaN(unitCountNumber) ? null : unitCountNumber,
      ...
      if (apartmentError || !apartment) {
        throw apartmentError ?? new Error("Apartman oluşturulamadı.");
      }
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-30 flex items-center justify-center bg-black/30 px-4">
          <div className="w-full max-w-md rounded-2xl bg-white shadow-xl">
            ...
            <form onSubmit={handleCreateApartment} className="px-6 py-5 space-y-4">
